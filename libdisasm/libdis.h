...
/* DLL Options */
/* Uncomment if using static library */
//#define LIBDISASM_API 
#ifndef LIBDISASM_API
    #ifdef LIBDISASM_EXPORT
        #define LIBDISASM_API __declspec(dllexport)
    #else
        #define LIBDISASM_API __declspec(dllimport)
    #endif
#endif
...
int LIBDISASM_API x86_init( enum x86_options options, DISASM_REPORTER reporter, void *arg);
void LIBDISASM_API x86_set_reporter( DISASM_REPORTER reporter, void *arg);
void LIBDISASM_API x86_set_options( enum x86_options options );
enum x86_options LIBDISASM_API x86_get_options( void );
int LIBDISASM_API x86_cleanup(void);
...
int LIBDISASM_API x86_insn_is_valid( x86_insn_t *insn );
 ...
 */
unsigned int LIBDISASM_API x86_disasm( unsigned char *buf, unsigned int buf_len,
 ...
 */
unsigned int LIBDISASM_API x86_disasm_range( unsigned char *buf, uint32_t buf_rva,
 ...
 */
unsigned int LIBDISASM_API x86_disasm_forward( unsigned char *buf, unsigned int buf_len,
	                         uint32_t buf_rva, unsigned int offset,
	                         DISASM_CALLBACK func, void *arg,
...
void LIBDISASM_API x86_oplist_free( x86_insn_t *insn );
 ...
 * criteria. */
int LIBDISASM_API x86_operand_foreach( x86_insn_t *insn, x86_operand_fn func, void *arg,
	       	  	 enum x86_op_foreach_type type);

/* convenience routine: returns count of operands matching 'type' */
size_t LIBDISASM_API x86_operand_count( x86_insn_t *insn, enum x86_op_foreach_type type );

/* accessor functions for the operands */
x86_op_t LIBDISASM_API * x86_operand_1st( x86_insn_t *insn );
x86_op_t LIBDISASM_API * x86_operand_2nd( x86_insn_t *insn );
x86_op_t LIBDISASM_API * x86_operand_3rd( x86_insn_t *insn );
...
unsigned int LIBDISASM_API x86_operand_size( x86_op_t *op );
...
uint32_t LIBDISASM_API x86_get_address( x86_insn_t *insn );
...
int32_t LIBDISASM_API x86_get_rel_offset( x86_insn_t *insn );
...
x86_op_t LIBDISASM_API * x86_get_branch_target( x86_insn_t *insn );
...
x86_op_t LIBDISASM_API * x86_get_imm( x86_insn_t *insn );
...
unsigned char LIBDISASM_API * x86_get_raw_imm( x86_insn_t *insn );


/* More accessor fuctions, this time for user-defined info... */
/* set the address (usually RVA) of the insn */
void LIBDISASM_API x86_set_insn_addr( x86_insn_t *insn, uint32_t addr );

/* set the offset (usually offset into file) of the insn */
void LIBDISASM_API x86_set_insn_offset( x86_insn_t *insn, unsigned int offset );
...
void LIBDISASM_API x86_set_insn_function( x86_insn_t *insn, void * func );
...
void LIBDISASM_API x86_set_insn_block( x86_insn_t *insn, void * block );
 ...
 * the tag field.*/ 
/* set insn->tag to 1 */
void LIBDISASM_API x86_tag_insn( x86_insn_t *insn );
/* set insn->tag to 0 */
void LIBDISASM_API x86_untag_insn( x86_insn_t *insn );
/* return insn->tag */
int LIBDISASM_API x86_insn_is_tagged( x86_insn_t *insn );
...
int LIBDISASM_API x86_format_operand(x86_op_t *op, char *buf, int len,
                  enum x86_asm_format format);

/* format (sprintf) an instruction mnemonic into 'buf' using specified syntax */
int LIBDISASM_API x86_format_mnemonic(x86_insn_t *insn, char *buf, int len,
                        enum x86_asm_format format);

/* format (sprintf) an instruction into 'buf' using specified syntax;
 * this includes formatting all operands */
int LIBDISASM_API x86_format_insn(x86_insn_t *insn, char *buf, int len, enum x86_asm_format);

/* fill 'buf' with a description of the format's syntax */
int LIBDISASM_API x86_format_header( char *buf, int len, enum x86_asm_format format);

/* Endianness of an x86 CPU : 0 is big, 1 is little; always returns 1 */
unsigned int LIBDISASM_API x86_endian(void);

/* Default address and operand size in bytes */
unsigned int LIBDISASM_API x86_addr_size(void);
unsigned int LIBDISASM_API x86_op_size(void);

/* Size of a machine word in bytes */
unsigned int LIBDISASM_API x86_word_size(void);

/* maximum size of a code instruction */
#define x86_max_inst_size(x) x86_max_insn_size(x)
unsigned int LIBDISASM_API x86_max_insn_size(void);

/* register IDs of Stack, Frame, Instruction pointer and Flags register */
unsigned int LIBDISASM_API x86_sp_reg(void);
unsigned int LIBDISASM_API x86_fp_reg(void);
unsigned int LIBDISASM_API x86_ip_reg(void);
unsigned int LIBDISASM_API x86_flag_reg(void);

/* fill 'reg' struct with details of register 'id' */
void LIBDISASM_API x86_reg_from_id( unsigned int id, x86_reg_t * reg );
...
size_t LIBDISASM_API x86_invariant_disasm( unsigned char *buf, int buf_len, 
			  x86_invariant_t *inv );
...
size_t LIBDISASM_API x86_size_disasm( unsigned char *buf, unsigned int buf_len );
